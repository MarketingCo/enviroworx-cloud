    ...
    return (
      <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-8 text-center text-white">
        ...
        <p className="text-slate-400 mb-8 max-w-sm">
          Supabase keys are missing in <strong>.env.local</strong>. 
          Please inform the office to complete the setup.
        </p>
        <div className="bg-slate-800 p-6 rounded-2xl text-left text-xs text-slate-500 font-mono">

...
export default function FleetTab() {
  ...
  const [issues, setIssues] = useState<Database["public"]["Tables"]["fleet_logs"]["Row"][]>([])
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 border border-white/5 rounded-xl p-5">
          ...
          <div className="space-y-3">
            ...
            {lorries.map((l: Database["public"]["Tables"]["lorries"]["Row"]) => (
        ...
        <div className="bg-slate-900 border border-white/5 rounded-xl p-5 shadow-xl">
          ...
          <div className="space-y-3">
            ...
            {drivers.map((d: Database["public"]["Tables"]["drivers"]["Row"]) => (
        ...
        <div className="bg-slate-900 border border-white/5 rounded-xl p-5">
          ...
          {issues.length === 0
            ...
            : <div className="space-y-3">
                {issues.map((iss: Database["public"]["Tables"]["fleet_logs"]["Row"]) => (

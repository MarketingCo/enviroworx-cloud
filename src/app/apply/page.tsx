  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <h1 className="text-4xl font-black uppercase tracking-tighter italic">Start Integration</h1>
        <p className="text-slate-400">
          Ready to modernize your operations? Contact us to begin your Enviroworx Cloud integration.
        </p>
        <Link
          href="/"

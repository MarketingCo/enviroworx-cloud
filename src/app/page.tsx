    ...
    <div className="bg-slate-950 text-white min-h-screen selection:bg-brand-green selection:text-white">
      ...
      <footer className="relative z-10 py-20 border-t border-white/5 bg-slate-950">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-10">
            ...
            <nav className="flex justify-center items-center gap-8 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500">
              <Link href="/blog" className="hover:text-brand-green transition-colors">Journal</Link>
              <Link href="/office" className="hover:text-brand-green transition-colors">Office Portal</Link>
              <Link href="/driver" className="hover:text-brand-green transition-colors">Driver App</Link>
              <Link href="/portal" className="hover:text-brand-green transition-colors">Client Portal</Link>
            </nav>
            ...
            <p className="text-sm text-center text-slate-500">Website developed by <a href="https://marketing-company.co.uk" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors underline">Marketing Company</a></p>
        </div>
      </footer>
    </div>
  );

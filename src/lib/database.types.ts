...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      vehicles: {
        Row: { active: boolean | null; created_at: string | null; heading: number | null; id: string; insurance_expiry: string | null; last_6weekly_date: string | null; last_service_date: string | null; last_service_mileage: number | null; last_updated: string | null; latitude: number | null; longitude: number | null; mot_due: string | null; name: string | null; notes: string | null; operator_licence: string | null; registration: string; speed: number | null; tare_weight: number | null; tax_due: string | null; type: string | null }
